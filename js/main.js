...
(function ($) {
    ...
    $(document).on('click', '.js-show-modal1', function(e) {
        e.preventDefault();
        alert("Button clicked");
        // Find the closest ancestor with class 'js-modal1' relative to the clicked button
        var modal = $(this).closest('.js-modal1');
        if (modal.length > 0) {
    ...
    // Event handler for hiding modal
...
// count increase and decrease for cart and whishlist
